...
fun AttendLogScreen(
    ...
    val uiState by attendLogViewModel.uiState.collectAsState()

    LaunchedEffect(true) {
        sharedViewModel.isShowAppBar(false)

        attendLogViewModel.isShowSnackbar.collectLatest {
            if (it) {
                        ...
                        PaginatedDataTable(
                            ...
                            uiState.logs.forEach { log ->
                                row {
                                    ...
                                    cell {
                                        Text(text = if (log.success) "Success" else "Failed", style = MaterialTheme.typography.bodySmall)
                                    }
                                }
                            }
                        }
        ...
        Box (
            ...
            Column(
                ...
                PaginatedDataTable(
                    ...
                    row {
                        cell {
                            Text(text = "2024-03-31 08:55:31", style = MaterialTheme.typography.bodySmall)
                        }
                        cell {
                        ...
                        cell {
                            Text(text = "BLE", style = MaterialTheme.typography.bodySmall)
                        }
                        cell {
                    ...
                    row {
                        cell {
                            Text(text = "2024-03-31 08:56:01", style = MaterialTheme.typography.bodySmall)
                        }
                        cell {
                            Text(text = "23001", style = MaterialTheme.typography.bodySmall)
                        }
                        cell {
                            Text(text = "116.48.55.81", style = MaterialTheme.typography.bodySmall)
                        }
                        cell {
                            Text(text = "BLE", style = MaterialTheme.typography.bodySmall)
                        }
